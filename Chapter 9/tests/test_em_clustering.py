...
class TestEMClustering(unittest.TestCase):
    def test_with_old_faithful(self):
        """
        test based on well known example - investigation of dependencies
        between eruption time and wait time of Old Faithful geyser and on
        code from https://commons.wikimedia.org/wiki/File:Em_old_faithful.gif
        """
